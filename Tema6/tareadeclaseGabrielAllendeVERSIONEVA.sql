...
CREATE VIEW ejClase (referencia, descripcion, preciobase, precioHoy, categoria) as 
	SELECT articulos.refart, articulos.nomart, articulos.preciobase, articulos.precioventa, articulos.codcat
    FROM articulos
